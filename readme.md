...
The responses for both the original form (where it redirected to the Google Form finish page) and the AJAX-submitted form (with the error) are both in this repository as `response-post.txt` and `response-ajax.txt`, respectively.
